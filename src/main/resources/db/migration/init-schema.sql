...
ALTER TABLE comment
    ADD CONSTRAINT FK_COMMENT_ON_COMMENTER FOREIGN KEY (commenter_id) REFERENCES app_user (id);
...
ALTER TABLE pin
    ADD CONSTRAINT FK_PIN_ON_OWNER FOREIGN KEY (owner_id) REFERENCES app_user (id);

ALTER TABLE post
    ADD CONSTRAINT FK_POST_ON_MUSIC FOREIGN KEY (music_id) REFERENCES music (id);

ALTER TABLE post
    ADD CONSTRAINT FK_POST_ON_ORIGINAL_POSTER FOREIGN KEY (original_poster_id) REFERENCES app_user (id);